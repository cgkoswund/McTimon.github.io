...
function main(rearTeethSetArray,frontTeethSetArray,activeRearGear,activeFrontGear, meshGenCallback){
    frontToothedGears = [];
    rearToothedGears = [];
...
function getTeethCount(rearTeethCount,paddleTeethCount){
    ...
    main(rearTeethCorrected,frontTeethCorrected,0,0,generateChainLinks);
...
function setActiveRearGear(activeRearGear,activeFrontGear){
    ...
    // timeCustom = 0;
    // isPopulatedBearing = isPopulatedPivot = isPopulatedSlate = isPopulatedSlateIn = false;
    main(rearTeethSet,frontTeethSet,activeRearGear,activeFrontGear,generateChainLinks);
